...
<body>
  ...
  <main>
    <div id="book-form-container">
      <div class="book-form">
        <h2><img class="edit-icon" src="images/edit-black.png" alt="">Edit Book Entry</h2>
        <form action="includes/manage-booklist(backend).php" method="POST">
          <label for="">ISBN</label>
          <input type="text" name="ISBN" id="" disabled="disabled" value="<?php echo $row['ISBN'] ?>" placeholder="XXX-X-XX-XXXXXX-X" />

          <label for="">Book Title</label>
          <input type="text" name="Book-Title" id="" value="<?php echo $row['Book_Title'] ?>" placeholder="Harry Potter" />

          <label for="">Book Publisher</label>
          <input type="text" name="publisher" id="" value="<?php echo $row['Book_Publisher'] ?>" placeholder="IDW Publishing" />
          ...
          <input type="text" name="edition" id="" value="<?php echo $row['Book_Edition'] ?>" placeholder="First Edition" />
