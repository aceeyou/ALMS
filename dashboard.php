<!-- dashboard with ext of php to show the data from the db  -->
            ...
            <div class="box">
                <div class="content">
                    <div class="top">
                        ...
                        <div class="data"><?php echo $numberOfBooks; ?></div>
                    </div>
                    <div class="bottom">
            ...
            <div class="box">
                <div class="content">
                    <div class="top">
                        ...
                        <div class="data"><?php echo $numberOfPatron; ?></div>
                    </div>
                    <div class="bottom">
