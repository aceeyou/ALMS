            ...
            <div class="book-form">
              ...
              <form action="includes/manage-borrowed(backend).php" method="POST">
                ...
                <input
                  ...
                  id=""
                  placeholder="S100"
                  value="<?php echo $row['Slip_Number']?>"
                />
                ...
                <input type="text" name="return-date" id="" placeholder="2020-05-03" value="<?php echo $row['Return_Date']?>" />
                ...
                <input
                  ...
                  name="pacct-id"
                  id=""
                  placeholder="100" value="<?php echo $row['PatronAccount_ID'] ?>"
                />
                ...
                <input
                  ...
                  name="copy-no"
                  id=""
                  placeholder="C1" value="<?php echo $row['ISBN']?>"
                />
