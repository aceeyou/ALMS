...
<body>
  ...
  <main>
    <div id="book-form-container">
      <div class="book-form">
        <h2>Edit Book Author <img class="edit-icon" src="/images/edit-black.png" alt=""></h2>
        <form action="includes/new-author.php" method="POST">
          <!-- Input form -->
          <label for="">First Name</label>
          <input type="text" name="Author_FirstName" id="" placeholder="JK" value="" />
          <!-- end -->

          <!-- Input form -->
          <label for="">Middle Name</label>
          <input type="text" name="Author_MiddleName" id="" placeholder="Something" />
          <!-- end -->

          <!-- Input form -->
          <label for="">Last Name</label>
          <input type="text" name="Author_LastName" id="" placeholder="Rowling" />
          <!-- end -->

          <!-- Input form -->
          <label for="">State Address</label>
          <input type="text" name="Author_StateAddress" id="" placeholder="Texas" />
          <!-- end -->

          <!-- Input form -->
          <label for="">Country Address</label>
          <input type="text" name="Author_CountryAddress" id="" placeholder="USA" />
          <!-- end -->

          <!-- Button -->
          <a href="manage-authors.html"><input class="edit-save-btn" type="submit" value="SAVE CHANGES" /></a>
          <!-- end -->
        </form>
      </div>
    </div>
